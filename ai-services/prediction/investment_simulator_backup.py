...
class InvestmentSimulator:
    ...
    def _calculate_traction_score(self, features: Dict[str, float]) -> float:
        """حساب نقاط الجذب"""
        user_count = float(features.get("user_count", 0))
        revenue_growth = float(features.get("revenue_growth", 0))
        user_engagement = float(features.get("user_engagement", 0))
        market_share = float(features.get("market_share", 0))
    ...
    def _calculate_team_quality_score(self, features: Dict[str, float], organization: str) -> float:
        """حساب جودة الفريق"""
        team_size = float(features.get("team_size", 0))
    ...
    def _calculate_market_size_score(self, features: Dict[str, float], sector: str) -> float:
        """حساب حجم السوق"""
        market_demand = float(features.get("market_demand", 0))
    ...
    def _calculate_financial_health_score(self, features: Dict[str, float]) -> float:
        ...
        rat_completion = float(features.get("rat_completion_rate", 0))
        roi = float(features.get("roi", 0))
