...
class StrategicAnalysisExcelExporter:
    def __init__(self):
...
def export_to_excel(analysis_data: Dict[str, Any], output_path: str) -> str:
    """
    Main function to export strategic analysis to Excel
    ...
    Returns:
        Path to generated Excel file
    """
    exporter = StrategicAnalysisExcelExporter()
...
if __name__ == "__main__":
    ...
    output = export_to_excel(sample_data, '/tmp/test_report.xlsx')
