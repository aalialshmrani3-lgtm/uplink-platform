...
export function ValueFootprintsSection() {
  ...
  const metrics = [
    {
      ...
      value: "1,000+",
      label: "Startups",
      description: "Founded through the platform",
    ...
    },
    {
      ...
      value: "10,000+",
      label: "New Jobs",
      description: "Created in supported startups",
    ...
    },
    {
      ...
      value: "10B+",
      label: "SAR Revenue",
      description: "Generated by supported companies",
  ...
  const goals = [
    {
      title: "Vision 2030",
      description: "Contributing to achieving Saudi Vision 2030 goals",
      icon: "🇸🇦"
    },
    {
      title: "Economic Growth",
      description: "Supporting economic growth through innovation",
      icon: "📈"
    },
    {
      title: "Global Competitiveness",
      description: "Reaching Top 20 in the Global Innovation Index",
      icon: "🏆"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
            {isAr ? "قياس الأثر" : "Impact Metrics"}
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            {isAr ? "نقيس الأثر الحقيقي للابتكار على الاقتصاد الوطني" : "We measure the real impact of innovation on the national economy"}
          </p>
        </div>
        ...
        <div className="text-center">
          <Link href="/value-footprints">
            <Button size="lg" className="gap-2">
              {isAr ? "استكشف التقارير" : "Explore Reports"}
