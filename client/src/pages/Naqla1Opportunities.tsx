 ...
 * 
 * Challenges and Hackathons are SUPPORT TOOLS in NAQLA1 to help innovators develop their ideas.
 * They are NOT NAQLA2 itself.
 * 
 * This page shows:
...
export default function Naqla1Opportunities() {
  ...
  const { data: challenges = [], isLoading: loadingChallenges } = trpc.naqla2.challenges.getAll.useQuery();
  const { data: hackathons = [], isLoading: loadingHackathons } = trpc.naqla2.hackathons.getAll.useQuery();
