...
export default function Naqla3() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950">
      ...
      {/* International IP Protection Section */}
      <section className="py-20 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            {[
              ...
              { icon: '🏆', title: 'توافق المعايير الدولية', desc: 'عقود IP متوافقة مع متطلبات المعايير الدولية لبرامج التسريع والتمويل الدولية', link: 'https://www.wipo.int/portal/ar/', badge: 'WIPO+', color: 'from-violet-600/20 to-violet-900/20 border-violet-500/30' },
          ...
          <div className="bg-gradient-to-r from-violet-900/30 to-blue-900/30 border border-violet-500/20 rounded-2xl p-6 text-center">
            <p className="text-slate-300 text-sm mb-3">
              📜 جميع العقود مطابقة لمعايير المنظمة العالمية للملكية الفكرية (WIPO) والاتحاد الأوروبي ومنظمة التجارة العالمية
            </p>
            <div className="flex justify-center gap-6 flex-wrap">
              ...
              <a href="https://www.epo.org/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 text-sm font-medium">🏆 EPO</a>
