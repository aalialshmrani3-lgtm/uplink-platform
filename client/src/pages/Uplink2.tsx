...
export default function Uplink2() {
  ...
  const organizerOptions = [
    {
      ...
      link: '/uplink2/challenges/create',
    },
    {
      id: 'host-hackathon',
      title: 'استضف هاكاثون',
      ...
      link: '/uplink2/hackathons/create',
    },
    {
      id: 'host-conference',
      title: 'استضف مؤتمر',
      ...
      link: '/uplink2/events/create?type=conference',
    },
    {
      id: 'host-workshop',
      ...
      link: '/uplink2/events/create?type=workshop',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      <SEOHead 
        title="UPLINK 2 - Events & Challenges Matching"
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-border/50 mb-8">
              ...
              <span className="text-sm text-muted-foreground">UPLINK 2 - منظومة الفعاليات والتحديات</span>
            </div>
