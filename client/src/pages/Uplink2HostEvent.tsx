// UPLINK2 - Host Event Dashboard (Hackathon/Workshop/Conference)
...
export default function Uplink2HostEvent() {
  const { user } = useAuth();
  ...
  const hostEventMutation = trpc.uplink2.events.host.useMutation({
    onSuccess: () => {
