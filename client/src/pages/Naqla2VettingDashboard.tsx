...
export default function Naqla2VettingDashboard() {
  ...
  const { data: pendingIPs, isLoading } = trpc.naqla2.vetting.getPendingIPs.useQuery();
      ...
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-white mb-4">
            NAQLA 2: لوحة مراجعة الملكية الفكرية
          </h1>
          <p className="text-xl text-blue-200">
            مراجعة وتقييم الملكيات الفكرية المسجلة من NAQLA1
          </p>
        </div>
