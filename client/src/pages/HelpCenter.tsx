...
export default function HelpCenter() {
  ...
  const faqs = [
    {
      question: "ما هي UPLINK 5.0؟",
      answer: "UPLINK 5.0 هي منصة متكاملة لإدارة الابتكار تجمع بين الذكاء الاصطناعي، البلوكتشين، والعقود الذكية لتوفير حل شامل للمبتكرين والمستثمرين والشركات.",
    },
    {
    ...
    {
      question: "هل يمكنني تكامل UPLINK مع أنظمتي الحالية؟",
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            كل ما تحتاجه للبدء والنجاح مع UPLINK 5.0
          </p>
