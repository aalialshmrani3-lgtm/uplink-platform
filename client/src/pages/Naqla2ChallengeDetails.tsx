...
export default function Naqla2ChallengeDetails() {
  ...
  const { data: challenge, isLoading } = trpc.naqla2.challenges.getById.useQuery({ id: challengeId });
  const { data: relatedIdeas } = trpc.naqla1.ideas.browse.useQuery({ challengeId });
  // const relatedIdeas = [];
  const { data: registration } = trpc.naqla2.challenges.getRegistration.useQuery(
    { challengeId },
    { enabled: !!user }
  );
  const { data: submissions } = trpc.naqla2.challenges.getSubmissions.useQuery({ challengeId });
            ...
            <div className="flex flex-col gap-3">
              {!user ? (
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Link href={`/naqla2/challenges/${challengeId}/submit`}>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gradient-to-br from-blue-950/50 to-indigo-950/30 border-blue-500/30">
              ...
              <CardContent>
                <Link href={`/naqla1/submit?challengeId=${challenge.id}`}>
