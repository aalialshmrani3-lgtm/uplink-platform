...
export default function Login() {
  ...
  const handleSocialLogin = (provider: 'google' | 'facebook' | 'twitter' | 'linkedin' | 'github') => {
    ...
    // Redirect to OAuth with provider
  ...
  const handleDefaultLogin = () => {
    ...
    // Redirect to OAuth (default Manus login)
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-card/95 backdrop-blur-sm border-border/50">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">{isAr ? "تسجيل الدخول" : "Log In"}</CardTitle>
          <CardDescription>{isAr ? isAr ? "مرحباً بك في منصة NAQLA 5.0" : "Welcome to NAQLA 5.0" : "Welcome to NAQLA 5.0"}</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground">{isAr ? isAr ? "أو استخدم" : "Or use" : "Or use"}</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Button 
              ...
              size="lg"
            >
              <svg className="w-5 h-5 ml-2" fill="#1DA1F2" viewBox="0 0 24 24">
            ...
            <Button 
              ...
              size="lg"
            >
              <svg className="w-5 h-5 ml-2" fill="#0A66C2" viewBox="0 0 24 24">
