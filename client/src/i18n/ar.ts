export const ar = {
  ...
  // Home Page
  home: {
    badge: 'منظومة تشغيل الابتكار',
    title: 'حوّل أفكارك إلى',
    titleHighlight: 'ابتكارات عالمية',
    description: 'NAQLA منظومة تشغيل للابتكار تنظّم السجلات والتحديات والاكتشاف والربط ضمن الصلاحيات المتاحة.',
    ...
    stats: {
      ...
      funding: 'قيمة تجريبية',
    },
    whyTitle: 'لماذا NAQLA؟',
    whySubtitle: 'قدرات عملية لإدارة رحلة الابتكار',
