...
export const CLASSIFICATION_LEVELS: ClassificationLevel[] = [
  {
    ...
    description: "فكرة مبتكرة تحقق معايير الابتكار (≥70%) وتستحق الانتقال المباشر إلى UPLINK2 للمطابقة مع المستثمرين والتحديات",
    nextSteps: [
      "✅ تم قبول فكرتك كابتكار حقيقي!",
      "🚀 الانتقال التلقائي إلى UPLINK2 للمطابقة مع:",
  ...
  },
  {
    ...
    description: "فكرة رائدة لها قيمة تجارية (50-70%) وتحل مشكلة معينة، لكنها لا تصل لمستوى الابتكار الجذري. تنتقل إلى UPLINK2 للمطابقة مع الفرص التجارية",
    nextSteps: [
  ...
  },
  {
    ...
    description: "فكرة لم تحقق المعايير المطلوبة حالياً (<50%). نشجعك على تطوير نفسك في المجالات المحددة وإعادة التقديم بعد التحسينات",
    nextSteps: [
...
المستويات الثلاثة (حسب Flowchart الرسمي):
- ابتكار حقيقي (≥70 نقطة) → انتقال تلقائي لـ UPLINK2 (Innovation Track)
- حل تجاري (50-70 نقطة) → انتقال تلقائي لـ UPLINK2 (Business Track)
- تحتاج تطوير (<50 نقطة) → إعادة مع اقتراحات تطوير
