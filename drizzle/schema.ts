...
export const courses = mysqlTable("courses", {
	...
	isFree: tinyint().default(1),
	certificateEnabled: tinyint().default(1),
...
export const eventRegistrations = mysqlTable("event_registrations", {
	...
	attendanceCertificateIssued: tinyint("attendance_certificate_issued").default(0),
	feedback: text(),
	rating: int(),
...
export const events = mysqlTable("events", {
	...
	agenda: json(),
	speakers: json(),
	sponsorsNeeded: tinyint("sponsors_needed").default(0),
	sponsorPackages: json("sponsor_packages"),
	confirmedSponsors: json("confirmed_sponsors"),
	innovatorsNeeded: tinyint("innovators_needed").default(0),
