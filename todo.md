...
- [ ] ربط سجل العرض ومسار التأهيل في `/naqla` بقراءة CR01 `getBundle` الخادمية بعد إنشائه
- [ ] ربط مسار NAQLA2 في `/naqla` بقراءة/إجراء listing وinterest خادميين أو إظهاره محجوباً بوضوح عند غياب التفويض
- [ ] ربط حالة NAQLA3 في `/naqla` بقراءة الأصل والمعاملة الخادميين أو إظهار الحجب الصريح
