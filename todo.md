...
- [ ] تنفيذ فحوص الإصدار النهائية للأمن والخصوصية والهجرات والبناء والأداء العملي والحزمة وخطة العرض والتشغيل والمخاطر
- [ ] إنشاء Release Candidate ونشره وإجراء smoke عام read-only ثم حزم التسليم والاستعادة وبصمات SHA-256
