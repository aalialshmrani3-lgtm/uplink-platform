...
- [ ] تنظيف علامات تعارض Git وبقايا التطوير الحاجبة للإصدار دون تغيير السلوك المقفل
- [ ] تدقيق سلامة المعمارية والكيانات القانونية وتغطية synthetic-auth وauthorization وprivacy والإلغاء على مستوى المنصة
...
- [ ] مراجعة وإصلاح الواجهات الحرجة للـRTL والـLTR والجوال واللوحي وإتاحة الوصول وحالات التحميل والخطأ والفراغ
...
- [ ] إزالة الادعاءات العامة غير المدمجة المثبتة في الصفحة الرئيسية وربط عرض المحركات بقدرات NAQLA الفعلية فقط
