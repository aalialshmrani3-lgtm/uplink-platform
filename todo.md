...
### UPLINK1 - نظام التسجيل الشامل:
- [ ] إضافة حقل "الصفة الاعتبارية" لجدول users (مستثمر، شركة، حكومة، منظمة، مؤسسة بحثية)
- [ ] بناء صفحة تسجيل شاملة مع خيارات الصفة الاعتبارية
- [ ] إضافة حقول إضافية حسب نوع الصفة (رقم السجل التجاري، رقم الترخيص، إلخ)
- [ ] بناء تدفق كامل: تقديم فكرة → عرض نتائج التحليل → خيارات الانتقال (UPLINK2/3)

### UPLINK2 - قدم تحدي وطلبات فعاليات:
- [ ] إضافة صفحة "قدم تحدي" للشركات والجهات
- [ ] إضافة جدول events لطلبات الفعاليات (مؤتمرات، ورش عمل)
- [ ] إضافة حقول نوع الفعالية (أونلاين/حضوري)
- [ ] بناء نظام البحث عن مبتكرين وموهوبين
- [ ] بناء نظام البحث عن رعاة للفعاليات
- [ ] إضافة workflow: موافقة → انتقال تلقائي لعقد في UPLINK3
