...
- [ ] استعادة شاشة افتتاح NAQLA الأصلية كطبقة boot مستقلة مع انتقال إلى المسار المطلوب من دون المساس بالواجهة أو backend
- [ ] تثبيت تعديل شاشة الافتتاح في checkpoint ونشره ثم smoke عام يثبت ظهورها وانتقال deep link بلا شاشة بيضاء
- [ ] تثبيت منفذ الإنتاج على `PORT` المطلوب في وضع production لمنع 503 البوابة مع الإبقاء على منفذ مرن للتطوير
